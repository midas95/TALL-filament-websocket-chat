...
@if($conversation['type'] == 'private')
    @if($message['user_id'] == $myUserId)
        ...
        <div class='flex {{!$repeated?'mt-6':'mt-1 mr-14'}} justify-end '>
            <div class='bg-emerald-800 text-white border-gray-300 p-2 pb-6 rounded-md {{!$repeated?'rounded-tr-none':''}} relative {{$message['edited']?'min-w-[120px]':''}}'>
                @if(!$repeated)
                ...
                @endif
                <div class="pr-12 message">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down hidden absolute right-2 font-bold" viewBox="0 0 16 16" onclick='showAction(event)'>
    ...
    @else
        <div class='flex {{!$repeated?'mt-6':'mt-1 ml-14'}} justify-start'>
            ...
            <div class='bg-black/50 p-2 rounded-md text-white {{!$repeated?'rounded-tl-none':''}} relative'>
                ...
                @endif
                <div class="pr-10 message">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down hidden z-50 absolute right-2 font-bold" viewBox="0 0 16 16" onclick='showAction(event)'>
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                    </svg>
